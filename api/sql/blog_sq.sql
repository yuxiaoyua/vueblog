...
insert  into `one_class`(`id`,`enname`,`cnname`,`time`) values ('YmM0ZjgwMjctMWI3NS00ZjNkLTkyODUtYjU2MWJhOGYyMzA3','eqe','一','2017-09-04 09:49:21');
...
insert  into `two_class`(`id`,`parent_id`,`enname`,`cnname`,`article_num`,`time`) values ('OTE5ZDBiMDEtMGU4NC00N2UxLThlZmEtOTBhYzk3YTNmOGFi','YmM0ZjgwMjctMWI3NS00ZjNkLTkyODUtYjU2MWJhOGYyMzA3','qweqe','二',0,'2017-09-04 09:49:21');
